...
my $dbh = DBI->connect('dbi:Oracle:host=tairdb01.tacc.utexas.edu;sid=tairtest;port=1521', '', '');
...
$SQL = sprintf ("SELECT tairObjectId, category, relationshipType, keyword, keywordLink FROM aip.LocusAnnotation ORDER BY 2, 3, 4");
