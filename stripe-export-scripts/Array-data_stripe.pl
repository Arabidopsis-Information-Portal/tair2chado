...
$SQL = sprintf ("SELECT tairObjectId, arrayElementId, name, single, avgLogRatio, stdError, avgIntensity, avgIntensityStdError, avgSignalPercentile, avgSignalPercentileStdError, viewerData, externalId FROM aip.LocusArrayElement WHERE single = '1' ");
&print_rows(1);
