...
$SQL = sprintf ("SELECT tairObjectId, globalAssignmentId, chromosome, mapId, mapName, mapType, mapElementType, length, units, orientation, startPosition, endPosition, annotations, attributions FROM aip.LocusGlobalAssignment");
